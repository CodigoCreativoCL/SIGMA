(function (window, document) {
    ...
    function refresh(root) {
        ...
        var documentState = bySuffix(root, 'hidTieneDocumento');
        var documento = (documentState && documentState.value === '1') ||
                        root.getAttribute('data-documento') === '1' || hasNewFile(root);
    ...
    function init() {
        ...
        if (!root) return;
        if (root.getAttribute('data-sg-ready') !== '1') {
