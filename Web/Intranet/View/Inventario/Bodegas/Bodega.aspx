        ...
        <rad:RadPageView ID="pvUbicaciones" runat="server">
            ...
            <asp:Panel ID="pnlUbicaciones" runat="server" Visible="false" CssClass="sigma-modal-section">
                ...
                <div class="sigma-modal-actions">
                    <%-- Cancelar solo aparece editando: un boton que en el
                         90% de los casos no hace nada es ruido. --%>
                    <WebControls:PushButton ID="btnCancelarUbicacion" runat="server" Text="Cancelar"
                        CssClass="ButtonCerrar" Visible="false" OnClick="btnCancelarUbicacion_Click" />
                ...
                <rad:RadGrid2 ID="GridUbicaciones" runat="server"
                    OnItemDataBound="GridUbicaciones_ItemDataBound"
                    OnItemCommand="GridUbicaciones_ItemCommand">
