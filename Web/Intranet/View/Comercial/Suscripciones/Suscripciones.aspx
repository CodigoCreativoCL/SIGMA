<%@ Page Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Suscripciones.aspx.cs" Inherits="View_Comercial_Suscripciones_Suscripciones" %>
    ...
    <script type="text/javascript">
        function abrirSuscripcion(query) {
            return SigmaModal.open({
                url: '<%=ResolveUrl("~/View/Comercial/Suscripciones/Suscripcion.aspx") %>?query=' + query,
                title: 'Suscripcion',
                width: 960,
                initialHeight: 620
            });
