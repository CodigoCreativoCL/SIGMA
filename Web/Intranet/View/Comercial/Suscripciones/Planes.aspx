<%@ Page Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Planes.aspx.cs" Inherits="View_Comercial_Suscripciones_Planes" %>
    ...
    <script type="text/javascript">
        function abrirPlan(query) {
            return SigmaModal.open({
                url: '<%=ResolveUrl("~/View/Comercial/Suscripciones/Plan.aspx") %>?query=' + query,
                title: 'Plan',
                width: 960,
                initialHeight: 640
            });
