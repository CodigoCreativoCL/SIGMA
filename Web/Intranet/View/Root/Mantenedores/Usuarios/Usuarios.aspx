<%@ Page Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeFile="Usuarios.aspx.cs" Inherits="View_Sistema_Usuarios_Usuarios" %>
    ...
    <script type="text/javascript">
        function abrir(query) {
            return SigmaModal.open({
                url: '<%=ResolveUrl("~/View/Root/Mantenedores/Usuarios/Usuario.aspx") %>?query=' + query,
                title: 'Usuario',
                width: 1000,
                initialHeight: 380
            });
