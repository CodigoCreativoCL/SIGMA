...
/* ========================================================================
   4. AUDITORIA
      Se usa el mecanismo que ya existe (Log + Log_Tabla) en vez de crear
      una tabla de historial paralela.
   ======================================================================== */

IF NOT EXISTS (SELECT 1 FROM [dbo].[Log_Tabla] WHERE [lot_tabla] = 'Cliente_Usuario_Permiso')
    INSERT INTO [dbo].[Log_Tabla] ([lot_tabla], [lot_columna_id], [lot_columna_usuario], [lot_columnas])
    VALUES ('Cliente_Usuario_Permiso', 'cpm_id', 'cpm_usuario_actualizacion',
            'cpm_permiso,cpm_cliente_instalacion,cpm_otorgado,cpm_fecha_inicio,cpm_fecha_fin,cpm_habilitado')
GO
