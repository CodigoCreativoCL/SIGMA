...
-- DESCRIPTION:     EL CONSUMO DE REPUESTOS DICE A QUE COMPONENTE FUE.
-- =============================================
-- SEL_ACTIVO_REPUESTO_CONSUMO (bloque 267) devolvia el NOMBRE del componente
-- pero no su id, asi que la pantalla no podia armar el historial de
-- reemplazos de UNA pieza: comparar por nombre se rompe el dia que dos
-- componentes se llaman parecido, que en una planta es casi siempre.
--
-- Se agrega COMPONENTE_ID. Lo demas queda igual.
-- TODO IDEMPOTENTE.
-- =============================================
...
GO
PRINT '--- SEL_ACTIVO_REPUESTO_CONSUMO actualizado con COMPONENTE_ID.'
GO

PRINT '273_ACTIVO_REPUESTO_COMPONENTE aplicado.'
GO
