...
-- ---------------------------------------------------------------------------
--   El hilo se lee con su propio SP y no como un @TIPO mas de la sabana:
--   necesita el JOIN a Dictado_Voz, que no le sirve a ninguna de las otras
--   consultas de tarea.
-- ---------------------------------------------------------------------------
