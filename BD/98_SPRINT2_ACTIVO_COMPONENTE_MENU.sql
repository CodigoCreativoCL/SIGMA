...
-- DESCRIPTION:     T-2116/T-2117 REGISTRA ACTIVO_COMPONENTE EN MENUS, CON PERMISO Y FUNCION.
-- =============================================
-- Va DESPUES de 97_SPRINT2_ACTIVO_COMPONENTE_DEMO.
--
...
-- escritura va en Menu_Funcion. La seguridad de datos la hace el filtro por
-- cliente en el listado y el SP.
--
-- ES IDEMPOTENTE.
-- =============================================
...
INSERT INTO @P VALUES
    (N'VER COMPONENTES',          N'Ver los componentes de los activos', N'ACTIVOS', 3),
    (N'CREAR EDITAR COMPONENTES', N'Registrar componentes de activos',   N'ACTIVOS', 1)
...
PRINT '--- Permisos de Componentes: ' + LTRIM(STR(@N_PERM)) + ' (esperado 2)'
GO
...
INSERT INTO @M VALUES
    (N'Componentes',              N'~/View/Activos/Componentes/ActivoComponentes.aspx', 5, 1, N'mdi mdi-puzzle-outline', N'VER COMPONENTES'),
    (N'Componente (detalle)',     N'~/View/Activos/Componentes/ActivoComponente.aspx',  99, 0, NULL,                    N'VER COMPONENTES')
...
DECLARE @N_MENU INT
SELECT @N_MENU = COUNT(*) FROM [dbo].[Menus] WHERE mnu_link COLLATE DATABASE_DEFAULT LIKE N'~/View/Activos/Componentes/%'
PRINT '--- Menus de Componentes: ' + LTRIM(STR(@N_MENU)) + ' (esperado 2)'
GO
...
INSERT INTO @F VALUES (N'~/View/Activos/Componentes/ActivoComponentes.aspx', N'Crear y editar', N'CREAR EDITAR COMPONENTES')
...
INSERT INTO @PP VALUES
    (1, N'VER COMPONENTES'), (1, N'CREAR EDITAR COMPONENTES'),
    (10,N'VER COMPONENTES'), (10,N'CREAR EDITAR COMPONENTES'),
    (5, N'VER COMPONENTES'), (5, N'CREAR EDITAR COMPONENTES'),
    (11,N'VER COMPONENTES'), (11,N'CREAR EDITAR COMPONENTES'),
    (12,N'VER COMPONENTES'), (13,N'VER COMPONENTES'), (4, N'VER COMPONENTES')
...
SELECT 'permisos de Componentes' AS control, COUNT(*) AS valor, 2 AS esperado
FROM   [dbo].[Permiso] WHERE prm_codigo IN (N'VER COMPONENTES', N'CREAR EDITAR COMPONENTES')
UNION ALL
SELECT 'pantallas de Componentes', COUNT(*), 2
FROM   [dbo].[Menus] WHERE mnu_link COLLATE DATABASE_DEFAULT LIKE N'~/View/Activos/Componentes/%'
UNION ALL
SELECT 'funciones de Componentes', COUNT(*), 1
FROM   [dbo].[Menu_Funcion] mf JOIN [dbo].[Menus] m ON m.mnu_id=mf.mfu_menu
WHERE  m.mnu_link COLLATE DATABASE_DEFAULT LIKE N'~/View/Activos/Componentes/%'
GO

PRINT '98_SPRINT2_ACTIVO_COMPONENTE_MENU aplicado.'
GO
