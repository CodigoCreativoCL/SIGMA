...
--
-- Log, Log_Estado y Log_Tabla salieron del modelo el 28-08-2026: nunca
-- existieron en esta base y el bloque 00 dio de baja los 12 triggers que
-- escribian en ellas. La auditoria de SIGMA es D10 Bitacora.
--
-- El modelo define 232 tablas en 15 dominios, de las cuales 48 son
...
-- D1 Organizacion y seguridad  (50 tablas)
