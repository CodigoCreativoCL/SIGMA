...
-- DESCRIPTION:     LAS POSICIONES FUNCIONALES BAJAN CON LA SABANA (HU-154 #2).
-- =============================================
-- Bryan: «las posiciones deben bajar en la sabana».
--
-- Escanear el QR de una posicion sin senal tiene que abrir igual el equipo
-- que la ocupa (o decir que esta vacia). Con los bloques que habia, la app
-- solo podia resolver ACT-<id>; un POS-<id> la dejaba sin respuesta.
--
-- Mismo mecanismo que los bloques 190, 192 y 208: el SP completo con el
-- bloque nuevo (11). SincronizacionController.BLOQUE_MAXIMO sube a 11 en el
-- mismo commit; ver la advertencia de ese numero en el controller.
-- =============================================
SET NOCOUNT ON
GO
