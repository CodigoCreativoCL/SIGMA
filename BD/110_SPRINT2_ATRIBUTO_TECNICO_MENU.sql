...
-- DESCRIPTION:     T-2307/T-2308 REGISTRA ATRIBUTOS TECNICOS EN MENUS, CON PERMISO Y FUNCION.
-- =============================================
-- Va DESPUES de 109_SPRINT2_ATRIBUTO_TECNICO_DEMO.
--
...
-- escritura va en Menu_Funcion. La seguridad de datos (T-2308) la hace el
...
INSERT INTO @P VALUES
    (N'VER ATRIBUTOS TECNICOS',          N'Ver los atributos técnicos', N'ACTIVOS', 3),
    (N'CREAR EDITAR ATRIBUTOS TECNICOS', N'Definir atributos técnicos de los tipos de activo', N'ACTIVOS', 1)
...
PRINT '--- Permisos de Atributos: ' + LTRIM(STR(@N_PERM)) + ' (esperado 2)'
GO
...
INSERT INTO @M VALUES
    (N'Atributos técnicos', N'~/View/Activos/Atributos/AtributoTecnicos.aspx', 8, 1, N'mdi mdi-format-list-bulleted-type', N'VER ATRIBUTOS TECNICOS'),
    (N'Atributo (detalle)', N'~/View/Activos/Atributos/AtributoTecnico.aspx',  99, 0, NULL,                                N'VER ATRIBUTOS TECNICOS')
...
DECLARE @N_MENU INT
SELECT @N_MENU = COUNT(*) FROM [dbo].[Menus] WHERE mnu_link COLLATE DATABASE_DEFAULT LIKE N'~/View/Activos/Atributos/%'
PRINT '--- Menus de Atributos: ' + LTRIM(STR(@N_MENU)) + ' (esperado 2)'
GO
...
INSERT INTO @F VALUES (N'~/View/Activos/Atributos/AtributoTecnicos.aspx', N'Crear y editar', N'CREAR EDITAR ATRIBUTOS TECNICOS')
...
INSERT INTO @PP VALUES
    (1, N'VER ATRIBUTOS TECNICOS'), (1, N'CREAR EDITAR ATRIBUTOS TECNICOS'),
    (10,N'VER ATRIBUTOS TECNICOS'), (10,N'CREAR EDITAR ATRIBUTOS TECNICOS'),
    (5, N'VER ATRIBUTOS TECNICOS'), (5, N'CREAR EDITAR ATRIBUTOS TECNICOS'),
    (11,N'VER ATRIBUTOS TECNICOS'), (11,N'CREAR EDITAR ATRIBUTOS TECNICOS'),
    (12,N'VER ATRIBUTOS TECNICOS'), (13,N'VER ATRIBUTOS TECNICOS'), (4, N'VER ATRIBUTOS TECNICOS')
...
SELECT 'permisos de Atributos' AS control, COUNT(*) AS valor, 2 AS esperado
FROM   [dbo].[Permiso] WHERE prm_codigo IN (N'VER ATRIBUTOS TECNICOS', N'CREAR EDITAR ATRIBUTOS TECNICOS')
UNION ALL
SELECT 'pantallas de Atributos', COUNT(*), 2
FROM   [dbo].[Menus] WHERE mnu_link COLLATE DATABASE_DEFAULT LIKE N'~/View/Activos/Atributos/%'
UNION ALL
SELECT 'funciones de Atributos', COUNT(*), 1
FROM   [dbo].[Menu_Funcion] mf JOIN [dbo].[Menus] m ON m.mnu_id=mf.mfu_menu
WHERE  m.mnu_link COLLATE DATABASE_DEFAULT LIKE N'~/View/Activos/Atributos/%'
GO

PRINT '110_SPRINT2_ATRIBUTO_TECNICO_MENU aplicado.'
GO
