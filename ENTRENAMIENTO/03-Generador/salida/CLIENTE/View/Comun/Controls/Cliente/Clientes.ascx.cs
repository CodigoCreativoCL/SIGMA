...
/// <summary>
/// CODE-BEHIND DEL LISTADO DE CLIENTE.
///
...
public partial class View_Comun_Controls_Cliente_Clientes : System.Web.UI.UserControl
{
    ...
    {
        get { return ViewState["URLNuevoCliente"] == null ? "" : ViewState["URLNuevoCliente"].ToString(); }
        set { ViewState["URLNuevoCliente"] = value; }
    }
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Grid.AddColumn("cli_id", "", Width: "3%");      // celda donde se inyecta el link Editar
            Grid.AddColumn("cli_nombre", "NOMBRE", Width: "10%");
    ...
    protected void CargarGrid()
    {
        ...
        Grid.DataSource = clienteController.GetClientes(filtro);
    }
    ...
    /// </summary>
    protected void rgrClientes_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == GridItemType.AlternatingItem | e.Item.ItemType == GridItemType.Item)
        {
            if (e.Item is GridDataItem)
            {
                ...
                string query = Server.UrlEncode(
                    Tools.Crypto.Encrypt("IdCliente=" + id + "&ReadOnly=" + ReadOnly));
                ...
                Editar.Attributes.Add("onclick", "abrirCliente('" + query + "')");

                item["cli_id"].Controls.Add(Editar);
            }
        }
    }
    ...
    protected void lnkDeshabilitar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            foreach (string idx in Grid.SelectedIndexes)
            {
                ...
                int id = int.Parse(value["cli_id"].ToString());

                Cliente cliente = new Cliente { cli_id = id };
                respuesta = clienteController.DeshabilitarCliente(cliente);
            }
