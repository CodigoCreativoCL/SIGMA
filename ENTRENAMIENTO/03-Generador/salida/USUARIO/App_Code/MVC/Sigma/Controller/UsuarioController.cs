...
namespace Sigma.Controller
{
    ...
    ///        SEL_USUARIO  INS_USUARIO  UPD_USUARIO  DEL_USUARIO
    ...
    public class UsuarioController
    {
            ...
            if (Token.TokenSeguridad())
            {
                ...
                try
                {
                    ...
                    if (usuario != null)
                    {
                        ...
                        // Seguridad por pais: CSV de paises permitidos del usuario logueado.
        ...
        /// Reutiliza el mismo SP SEL_USUARIO pasandole @ID.
        /// </summary>
        ...
        public Respuesta InsertUsuario(Usuario usuario)
        {
            ...
            if (Token.TokenSeguridad())
            {
                ...
                try
                {
                    ...
                    cmdExecute.Parameters.AddWithValue("@TELEFONO", (object)usuario.usu_telefono ?? DBNull.Value);
        ...
        public Respuesta UpdateUsuario(Usuario usuario)
        {
            ...
            if (Token.TokenSeguridad())
            {
                ...
                try
                {
                    ...
                    // La contrasena solo se manda si el usuario la cambio.
        ...
        /// DEL_USUARIO existe solo para casos excepcionales.
        /// </summary>
