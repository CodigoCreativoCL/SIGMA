...
/// <summary>
/// CODE-BEHIND DEL TAB / SUB-FORMULARIO DE USUARIO.
///
...
public partial class View_Seguridad_Controls_Usuario_Identidad : System.Web.UI.UserControl
{
            ...
            if (sender is RadComboBox2)
            {
                ...
                switch (ctrl.ID)
                {
                    ...
                    case "cboPais":
                        ...
                        PaisesController paisController = new PaisesController();
                        ...
                        ctrl.Items.Add(new RadComboBoxItem("Seleccione...", ""));
                        ctrl.AppendDataBoundItems = true;
                        ctrl.DataSource = paisController.GetPaises(filtroPais);
                        ctrl.DataValueField = "pai_id";   // debe existir en el Model
    ...
    protected void btnGuardar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Tools.tools.ClientAlert("Debe ingresar contrasena para el registro nuevo.", "alerta");
                return;
            }
