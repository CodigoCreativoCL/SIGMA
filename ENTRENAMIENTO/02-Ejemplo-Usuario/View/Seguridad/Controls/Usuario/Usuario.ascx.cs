...
/// <summary>
/// CODE-BEHIND DEL CONTENEDOR DE TABS.
///
...
/// </summary>
public partial class View_Seguridad_Controls_Usuario_Usuario : System.Web.UI.UserControl
{
    #region PROPIEDADES
    ...
    /// <summary>0 = alta de un usuario nuevo. > 0 = edicion de un usuario existente.</summary>
    ...
    public string URLVolverUsuario
    {
        get { return ViewState["URLVolverUsuario"] == null ? "" : ViewState["URLVolverUsuario"].ToString(); }
        set { ViewState["URLVolverUsuario"] = value; }
    }
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        // Si en el futuro se agregan tabs (Accesos, Instalaciones, ...),
        // se les pasan las mismas propiedades aqui y nada mas cambia.
    }
}
