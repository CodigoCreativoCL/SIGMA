...
**Última actualización:** 29-08-2026 (bloque C de suscripción)
...
| **API** | `C:\Capstone\SIGMA\Solucion\SIGMA\API` — ASP.NET Web API 2, .NET 4.8, JWT. Publicada en `http://localhost/SIGMA/Servicio/API`. **Su estado tiene documento propio: [`SIGMA_ESTADO_DESARROLLO_API.md`](SIGMA_ESTADO_DESARROLLO_API.md)** |
...
| Permisos | 54 |
| Perfiles | 9 |
| Páginas registradas en `Menus` | 52 (8 de ellas, Comercial) |
