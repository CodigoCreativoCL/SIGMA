      ...
      body: Stack(
        ...
        children: [
          MobileScanner(
            ...
            errorBuilder: (_, e) =>
                _SinCamara(mensaje: e.errorDetails?.message),
          ),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Row(
      ...
      children: [
        ...
        Text(
          'Apunta al código de la posición',
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color(0x0000E0C2), SgColor.teal, Color(0x0000E0C2)],
                ),
                boxShadow: [
  ...
  Widget build(BuildContext context) => Row(
    children: [
      const SizedBox(
        width: 22,
        height: 22,
        child: CircularProgressIndicator(strokeWidth: 2.4, color: SgColor.teal),
      ),
        ...
        child: Center(
          child: Row(
            ...
            children: [
              ...
              const SizedBox(width: 8),
              Text(texto, style: sora(16, 600, color: const Color(0xFFF8FAFC))),
            ],
          ),
        ),
      ),
            ...
            Text(
              mensaje?.isNotEmpty == true
                  ...
                  : 'Revisa el permiso de cámara de SIGMA en los ajustes '
                        ...
                        'código a mano.',
              textAlign: TextAlign.center,
              style: sora(14, 500, color: const Color(0xFF64748B), alto: 1.55),
            ),
          ],
        ),
      ),
