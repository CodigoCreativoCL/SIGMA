<%@ page language="C#" masterpagefile="~/Master/Simple.master" autoeventwireup="true" inherits="View_Inventario_Repuestos_Repuesto, App_Web_5jlpag0f" %>
        ...
        <rad:RadPageView ID="pvDatos" runat="server">
            ...
            <div class="sigma-form-seccion">
                ...
                <div class="ayuda">
                    ...
                    horómetros de instalación y retiro, y es otra historia (HU-058).
                </div>
