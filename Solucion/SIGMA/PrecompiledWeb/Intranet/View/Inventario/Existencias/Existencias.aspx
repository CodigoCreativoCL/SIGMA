<%@ page language="C#" masterpagefile="~/Master/Default.master" autoeventwireup="true" inherits="View_Inventario_Existencias_Existencias, App_Web_sb44wdff" %>
...
<asp:Content ID="ContentScript" ContentPlaceHolderID="chpScript" runat="server">
    <script type="text/javascript">
        function abrirExistencia(query) {
            ...
            oWin.setUrl('<%=ResolveUrl("~/View/Inventario/Existencias/Existencia.aspx") %>?query=' + query);
            oWin.show();
        }
