<%@ page language="C#" masterpagefile="~/Master/Default.master" autoeventwireup="true" inherits="View_Organizacion_CentrosCosto_CentrosCosto, App_Web_emrlze2e" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:UpdatePanel runat="server" ID="udPanel" UpdateMode="Conditional">
        <ContentTemplate>
            <rad:RadGrid2 ID="Grid" runat="server" OnItemDataBound="rgrCentrosCosto_ItemDataBound">
